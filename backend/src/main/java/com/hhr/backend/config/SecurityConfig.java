        ...
        httpSecurity
                .csrf(AbstractHttpConfigurer::disable)
                    .authorizeHttpRequests(request -> request
                            .requestMatchers("/auth/signin", "/auth/signup", "/users", "/products", "/product/search").permitAll()
                            .requestMatchers("/auth/refresh").hasAnyAuthority("ADMIN","USER")
                            .requestMatchers("/users/create", "/users/update/", "/products/create", "/products/update","products/delete").hasAuthority("ADMIN")
